...
if (isAliveP1) then {_task1 = [west, (str taskID), [_description, _title, _waypoint], [p1, true], "CREATED", 0, false, "", true] call BIS_fnc_taskCreate}, [str taskID, p1TaskIcon] call BIS_fnc_taskSetType, [str taskID, true] call BIS_fnc_taskSetAlwaysVisible;
eastTaskID1 = taskID;
taskID = taskID + 1;
if (isAliveP2) then {_task1 = [west, (str taskID), [_description, _title, _waypoint], [p2, true], "CREATED", 0, false, "", true] call BIS_fnc_taskCreate}, [str taskID, p2TaskIcon] call BIS_fnc_taskSetType, [str taskID, true] call BIS_fnc_taskSetAlwaysVisible;
eastTaskID2 = taskID;
taskID = taskID + 1;
if (isAliveP3) then {_task1 = [west, (str taskID), [_description, _title, _waypoint], [p3, true], "CREATED", 0, false, "", true] call BIS_fnc_taskCreate}, [str taskID, p3TaskIcon] call BIS_fnc_taskSetType, [str taskID, true] call BIS_fnc_taskSetAlwaysVisible;
eastTaskID3 = taskID;
taskID = taskID + 1;
if (isAliveP4) then {_task1 = [west, (str taskID), [_description, _title, _waypoint], [p4, true], "CREATED", 0, false, "", true] call BIS_fnc_taskCreate}, [str taskID, p4TaskIcon] call BIS_fnc_taskSetType, [str taskID, true] call BIS_fnc_taskSetAlwaysVisible;
eastTaskID4 = taskID;
taskID = taskID + 1;
